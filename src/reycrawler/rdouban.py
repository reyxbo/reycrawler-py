...
class CrawlerORMTableDoubanMedia(CrawlerBase, rorm.Table):
    ...
    language: rorm.Json | None = rorm.Field(rorm.JSONB, comment='Language list.')
    alias: rorm.Json | None = rorm.Field(rorm.JSONB, comment='Alias list.')
    comment: rorm.Json | None = rorm.Field(rorm.JSONB, comment='Comment list.')
