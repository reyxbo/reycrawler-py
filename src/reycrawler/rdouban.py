...
class DatabaseORMTableDoubanMedia(rorm.Table):
    ...
    minute: int | None = rorm.Field(rorm.types.SMALLINT, comment='Movie or TV drama episode minute.')
    episode: int | None = rorm.Field(rorm.types.SMALLINT, comment='TV drama total episode number.')
    episode_now: int | None = rorm.Field(rorm.types.SMALLINT, comment='TV drama current episode number.')
    premiere: str | None = rorm.Field(rorm.JSONB, comment='Premiere region and date dictionary.')
    country: str | None = rorm.Field(rorm.JSONB, comment='Release country list.')
    class_: str | None = rorm.Field(rorm.JSONB, comment='Class list.', name='class')
    director: str | None = rorm.Field(rorm.JSONB, comment='Director list.')
    star: str | None = rorm.Field(rorm.JSONB, comment='Star list.')
    scriptwriter: str | None = rorm.Field(rorm.JSONB, comment='Scriptwriter list.')
    language: str | None = rorm.Field(rorm.JSONB, comment='Language list.')
    alias: str | None = rorm.Field(rorm.JSONB, comment='Alias list.')
    comment: str | None = rorm.Field(rorm.JSONB, comment='Comment list.')
    ...
    video: str | None = rorm.Field(rorm.types.VARCHAR(150), comment='Preview video Douban page URL.')

class CrawlerDouban(CrawlerBase):
    """
    Crawl Douban website crawler type.
